...
# 1. API Configuration (prefer environment variables with safe fallbacks for local dev)
api_key = os.getenv("OPENAI_API_KEY", "sk-Fbf6T3Gd8o3srcifmRyfUa3PfKmtbNuYgNzind0j92h2sV3n")
base_url = os.getenv("OPENAI_BASE_URL", "https://api.ai190.com/v1")
model_name = os.getenv("OPENAI_MODEL", "gemini-2.5-pro")
# Specialized API for Intent Classification (faster model)
DEEPSEEK_API_KEY = os.getenv("DEEPSEEK_API_KEY", "C5dgRQ47zWYzeNGpS7YU9kQIEoP4KiGfPDdnrnLFwRE1AJaUCNN5acwtACD69-XPyOiqPI8H5tFMHJLxVuAJQA")
DEEPSEEK_BASE_URL = os.getenv("DEEPSEEK_BASE_URL", "https://www.sophnet.com/api/open-apis/v1")
DEEPSEEK_INTENT_MODEL = os.getenv("DEEPSEEK_INTENT_MODEL", "DeepSeek-V3-Fast")
